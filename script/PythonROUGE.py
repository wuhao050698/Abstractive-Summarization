...
if __name__ == '__main__':
    guess_summary_list = ['/home/intern/wu/Global-Encoding-master/data/ans2/valid.tgt.id']
    ref_summ_list = ['/home/intern/wu/Global-Encoding-master/data/ans2/valid.src.id']
